...
public class SwiftBackgroundLocationPlugin: NSObject, FlutterPlugin, CLLocationManagerDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        SwiftBackgroundLocationPlugin.channel = FlutterMethodChannel(
            name: "com.almoullim.background_location/methods",
    ...
    private func initLocationManager(_ backgroundUpdates: Bool) {
        if SwiftBackgroundLocationPlugin.locationManager == nil {
            ...
            if backgroundUpdates {
                ...
                SwiftBackgroundLocationPlugin.locationManager?
    ...
    public func locationManager(
        ...
        let location =
            [
                ...
                "speed_accuracy": locations.last!.speedAccuracy,
                "altitude": locations.last!.altitude,
                "ellipsoidal_altitude": locations.last!.ellipsoidalAltitude,
                "altitude_accuracy": locations.last!.verticalAccuracy,
                "latitude": locations.last!.coordinate.latitude,
                "longitude": locations.last!.coordinate.longitude,
                "accuracy": locations.last!.horizontalAccuracy,
                "bearing": locations.last!.course,
                "bearing_accuracy": locations.last!.courseAccuracy,
